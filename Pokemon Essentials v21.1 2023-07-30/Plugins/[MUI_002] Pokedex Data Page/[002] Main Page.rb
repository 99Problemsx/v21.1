...
class PokemonPokedexInfo_Scene 
  ...
  def pbGenerateDataLists(species)
    @data_hash.clear
    #---------------------------------------------------------------------------
    # Generates list of species that share the same habitat.
    #---------------------------------------------------------------------------
    @data_hash[:habitat] = Array.new
    @dexlist.each do |dex|
      next if @species == dex[:species]
      next if !$player.owned?(dex[:species])
      next if species.habitat != GameData::Species.get(dex[:species]).habitat
      @data_hash[:habitat].push(dex[:species])
    end
    #---------------------------------------------------------------------------
    # Generates list of species that share the same color & shape.
    #---------------------------------------------------------------------------
    ...
    #---------------------------------------------------------------------------
    # Generates list of species that share the same base stats.
    #---------------------------------------------------------------------------
    ...
    #---------------------------------------------------------------------------
    # Generates list of species that share the same egg groups.
    #---------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Gets data for special forms, such as Mega Evolutions.
  #-----------------------------------------------------------------------------
